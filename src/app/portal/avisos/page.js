...
const TIPO_CFG = {
  reunion:  { label: 'Reunión',          color: '#818cf8', bg: 'rgba(129,140,248,0.12)' },
  pago:     { label: 'Pago',             color: '#4ade80', bg: 'rgba(74,222,128,0.12)'  },
  campana:  { label: 'Campaña',          color: '#fb923c', bg: 'rgba(251,146,60,0.12)'  },
  documento:{ label: 'Documento',        color: '#38bdf8', bg: 'rgba(56,189,248,0.12)'  },
  general:  { label: 'Aviso general',    color: '#94a3b8', bg: 'rgba(148,163,184,0.12)' },
}
...
function IconBell() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.4}>
    ...
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      {avisos.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-sm font-medium" style={{ color: 'rgba(255,255,255,0.4)' }}>Sin notificaciones</p>
          <p className="text-xs mt-1" style={{ color: 'rgba(255,255,255,0.2)' }}>
            La cooperativa te enviará avisos aquí
          </p>
        </div>
      ) : (
          ...
          {avisos.map(aviso => {
            ...
            return (
              <div
                ...
                className="relative flex gap-4 px-4 py-4 rounded-2xl cursor-pointer transition-all"
                style={{
                  backgroundColor: aviso.leida ? 'rgba(255,255,255,0.03)' : 'rgba(255,255,255,0.07)',
                  border: aviso.leida
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    <p className="text-sm font-semibold leading-snug"
                      style={{ color: aviso.leida ? 'rgba(255,255,255,0.6)' : '#fff' }}>
                      {aviso.titulo}
                    </p>
                    {!aviso.leida && (
