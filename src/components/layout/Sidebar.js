    ...
    <div className="flex flex-col min-h-screen w-60 flex-shrink-0" style={{ backgroundColor: '#0f172a' }}>
      ...
      <div className="px-5 py-5" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div className="flex items-center gap-2">
          <img src="/logo.png" alt="OlivaGest" className="w-7 h-7 rounded-lg flex-shrink-0" />
          <div>
            <p className="text-white font-bold text-sm leading-tight">OlivaGest</p>
            <p className="text-xs leading-tight" style={{ color: '#4ade80' }}>Gestión oleícola</p>
          </div>
        </div>
      </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              style={{
                backgroundColor: isActive ? 'rgba(74,222,128,0.12)' : 'transparent',
            ...
            >
              <span className="flex-shrink-0" style={{ color: isActive ? '#4ade80' : 'rgba(255,255,255,0.4)' }}>
                {item.icon}
              </span>
              <span>{item.label}</span>
              {isActive && (
                <span className="ml-auto flex-shrink-0 w-1.5 h-1.5 rounded-full" style={{ backgroundColor: '#4ade80' }} />
              )}
            </Link>
          )
        })}
      ...
      <div className="px-3 py-3" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <p className="text-xs px-3 mt-2" style={{ color: 'rgba(255,255,255,0.2)' }}>OlivaGest v1.0</p>
      </div>
